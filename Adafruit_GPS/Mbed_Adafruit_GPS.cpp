...
// buffer to read Serial data with mbed BufferedSerial class
...
Adafruit_GPS::Adafruit_GPS(BufferedSerial *ser)
{
  ...
  gpsSerial = ser; // ...override gpsSerial with value passed.
}
...
{
  gpsSerial->write(buf, sizeof(str));
}
